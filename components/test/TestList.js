...
import { Text, View, StyleSheet, TouchableOpacity, Animated, PanResponder, FlatList, Image } from 'react-native';
					...
					{testArr.map(item => (
						...
						>
							...
							<View style={styles.questView}>
								<Text style={styles.quest}>Вопрос {testArr[this.state.currentIndex].questionNum}</Text>
							</View>

							<View style={styles.starView}>
								<Icon style={styles.backIcon} name="star" type="entypo" size={15} color="#e5e853" />
								<Icon style={styles.backIcon} name="star" type="entypo" size={15} color="#e5e853" />
								<Icon style={styles.backIcon} name="star" type="entypo" size={15} color="#e5e853" />
								<Icon style={styles.backIcon} name="star" type="entypo" size={15} color="#e5e853" />
								<Icon style={styles.backIcon} name="star" type="entypo" size={15} color="#e5e853" />
